...
public:
  enum Value
  {
    ...
    While,
    //Operators
    ScopeResolution = TokenCategory::OperatorToken | 62,
    PlusPlus,
    MinusMinus,
    Plus,
    Minus,
    ...
    Comma,
    // Misc
    UserDefinedName = TokenCategory::Identifier | 97,
    UserDefinedLiteral = TokenCategory::Literal | 98,
    SingleLineComment = 99,
    LeftRightPar,
    LeftRightBracket,
